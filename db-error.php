...
if ( defined( 'WP_CLI' ) ) {
	...
	function info_msg( $message, $type = 'INFO' ) {
		echo "\033[33m{$type}: \033[0m{$message} \n";
	}

	function debug_msg( $message, $type = 'DEBUG' ) {
		echo "\033[36m{$type}: \033[0m{$message} \n";
	}
...
// Also show errors if WP_DEBUG is enabled
	...
	if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) { ?>
        ...
        <head>
            ...
            <meta name="description" content="503 Service not available">
        ...
        <div class="container">
            <!-- Jumbotron -->
            <div class="jumbotron">
                <h1><i class="fa fa-exclamation-triangle orange"></i> 503 Service not available</h1>
                <p class="lead">Website <em><span id="display-domain"><?php echo $_SERVER['HTTP_HOST']; ?></span></em> there was a temporary error.</p>
                <a href="javascript:document.location.reload(true);" class="btn btn-default btn-lg text-center"><span class="green">Reload this page here</span></a>
            </div>
        </div>
        <div class="container">
            <div class="body-content">
                <div class="row">
                    <div class="col-md-6">
                        <h2>What happened?</h2>
                        <p class="lead">The 503 error code means that the server has a temporary short term problem or is currently being maintained. The error disappears normally
                            quickly.</p>
                    </div>
                    <div class="col-md-6">
                        <h2>What can I do?</h2>
                        <p class="lead">If you are a site user</p>
                        <p>We apologize for a downtime, our monitoring has detected a problem and is being investigated.</p>
                        <p class="lead">If you are the site owner</p>
                        <p>The problem is probably temporal, but you can certainly check site space usage and database connection.</p>
                    </div>
                </div>
            </div>
        </div>
